...
//
// PriLearning.swiftpm is canonical. PriLearning 2.swiftpm is still retained
// because some Swift Playgrounds installs open that package directly. Letting
// either bundled web runtime drift means two files with the same app name can
// execute different client/handwriting code — exactly the kind of split-brain
// state a production app cannot tolerate.
//
