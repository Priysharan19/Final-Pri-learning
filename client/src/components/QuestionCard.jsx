                    ...
                    {!photo
                      ...
                      : (
                        <div className="photo-attach">
                          ...
                          <div style={{ flex: 1 }}>
                            {photoOCR.phase === 'reading' && <span className="muted">{t('verdict.readingWithVision')}</span>}
                            {photoOCR.phase === 'done' && (
                              <>
                                <div style={{ fontSize: 12.5, marginBottom: 6 }}><b>{t('verdict.decodedOnDevice')}</b>{photoOCR.confidence ? t('verdict.ocrConfidence', { percent: Math.round(photoOCR.confidence * 100) }) : ''}</div>
                ...
                {inkPhase === 'failed' && (
                  <div className="editor-body">
                    <div className="error-box" role="alert" style={{ marginBottom: 0 }}>
                      <b>{t('verdict.inkFailedTitle')}</b>{' '}
                      {t(inkStuck ? 'verdict.inkFailedStuck' : 'verdict.inkFailedRetry')}
                    </div>
