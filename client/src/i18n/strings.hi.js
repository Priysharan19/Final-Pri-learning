...
export default {
  ...
  'practice.pyqFilterOff': 'केवल-पिछले-वर्ष फ़िल्टर बंद करें',
  ...
  'verdict.pdfPagesUnread': '{total} में से {unread} पेज नहीं पढ़े जा सके — जाँच से पहले नीचे अपना हल देख लीजिए।',
  ...
  'verdict.inkNeedsDownloadTitle': 'लिखावट पहचान के लिए एक बार डाउनलोड चाहिए।',
  'verdict.inkNeedsDownloadBody': 'पहचानकर्ता एक अलग फ़ाइल है, जिसे पहली इंस्टॉल से बाहर रखा गया है ताकि जो फ़ोन कभी हाथ से नहीं लिखता वह उसका बोझ न उठाए — और यह डिवाइस अभी ऑफ़लाइन है, इसलिए उसे लाया नहीं जा सकता। एक पल के लिए कनेक्ट कीजिए और वह हमेशा के लिए इसी डिवाइस पर आपका हो जाएगा, उसके बाद नेटवर्क की ज़रूरत नहीं। आपका किया हुआ कुछ भी नहीं गया है, और आप अभी टाइप करके उत्तर दे सकते हैं।',
  ...
  'settings.helpBodyIndia': 'हर अध्याय की एक कौशल रेटिंग होती है जो हर उत्तर के साथ बदलती है — कठिन प्रश्न उसे ज़्यादा बदलते हैं। स्मार्ट अभ्यास लगभग 70% सफलता का लक्ष्य रखता है और टॉपिक भूलने से पहले उनकी पुनरावृत्ति बीच-बीच में डालता है। अंक अनुमान केवल पेपर के उन हिस्सों को कवर करता है जिनका आपने अभ्यास किया है, और यह उसे कभी CBSE प्रतिशत, JEE पर्सेंटाइल या रैंक में नहीं बदलता — घर के अभ्यास से इनमें से कोई भी ईमानदारी से नहीं निकाला जा सकता। हाथ से लिखे उत्तर इसी डिवाइस पर पहचाने जाते हैं — स्ट्रोक → चिह्न → गणित — और फिर उसी इंजन से पंक्ति दर पंक्ति जाँचे जाते हैं जो टाइप किए उत्तरों को जाँचता है। संकेत और दोबारा कोशिश पर भी श्रेय मिलता है, बस थोड़ा कम।',
