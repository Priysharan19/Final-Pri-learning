...
import { commercialConfig } from '../platform/billing.js';
import { normalizeCommercialDisplay } from '../../client/src/platform/entitlements.js';
...
try {
  ...
  const entitlementSource = readFileSync(new URL('../../client/src/platform/entitlements.js', import.meta.url), 'utf8');
  const panelSource = readFileSync(new URL('../../client/src/components/CloudAccountPanel.jsx', import.meta.url), 'utf8');
